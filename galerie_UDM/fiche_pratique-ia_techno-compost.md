...
| Mur droit   | Mosaïque d’images montrant des échantillons : certaines proches du bruit visuel, d’autres plus structurées |
...
|-----------------|------------------|
| **Composantes** | Projection vidéo, mur d’images, installation immersive (chaise/structure), casque VR, expérience immersive du spectateur |
| **Techniques**  | Génération IA, projection vidéo, impression numérique, VR, installation multimédia, accumulation/collage visuel, dispositif interactif |
